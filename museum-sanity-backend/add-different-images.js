...
async function addDifferentImages() {
  console.log('Adding different images to exhibits...');
  ...
  try {
    ...
    for (const exhibit of exhibits) {
      ...
      const imageUrl = differentImages[exhibit.inventarnummer];
      if (!imageUrl) {
      ...
      const filename = `exhibit-${exhibit.inventarnummer}-different.jpg`;
      ...
      if (imageAsset) {
        ...
        console.log(`  ✓ Image updated with different image`);
      }
    ...
    console.log('\n✓ All exhibit images updated with different images!');
...
// Run the script
addDifferentImages().catch(console.error);

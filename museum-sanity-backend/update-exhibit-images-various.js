...
// Various different images from Wikipedia for each exhibit
const variousImages = {
...
async function updateExhibitImages() {
  console.log('Updating exhibit images with various Wikipedia images...');
  ...
  try {
    ...
    console.log('\n✓ All exhibit images updated with various Wikipedia images!');
